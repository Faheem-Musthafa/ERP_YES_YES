...
const STATUS_STYLES: Record<string, string> = {
    ...
    Archived: 'bg-slate-100 text-slate-800 border-slate-300/80 dark:bg-slate-900/70 dark:text-slate-300',
    ...
    Advance: 'bg-red-100 text-red-900 border-red-300/80 dark:bg-red-950/60 dark:text-red-300',
    ...
    Reversed: 'bg-orange-100 text-orange-900 border-orange-300/80 dark:bg-orange-950/60 dark:text-orange-300',
    Voided: 'bg-slate-100 text-slate-800 border-slate-300/80 dark:bg-slate-900/70 dark:text-slate-300',
    ...
    'Not Collected': 'bg-slate-100 text-slate-800 border-slate-300/80 dark:bg-slate-900/70 dark:text-slate-300',
