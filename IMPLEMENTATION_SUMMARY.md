...
## 1. ✅ LOCATION FIELD FOR CUSTOMERS (Calicut/Chenakkal)
...
### Implementation
- **CustomerForm**:
  - Added location selector (dropdown: Calicut/Chenakkal)
...
Acme Corp,9876543210,"123 Main St",Kochi,Calicut,682001,
...
- **Pie Chart**: Customers by Location (Calicut vs Chenakkal)
...
- **Location Filter**: Dropdown (All/Calicut/Chenakkal)
...
```
- Optional field
- Accepts: NULL, "Calicut", "Chenakkal", or custom values
...
- [ ] **CSV Import**: Test with sample CSV file
  ```csv
  name,phone,address,place,location,pincode,gst_pan
  Test Co,9876543210,123 Main St,Kochi,Calicut,682001,22AAAAA0000A1Z5
  ```
...
2. Sees breakdown by location (Calicut vs Chenakkal)
